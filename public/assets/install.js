...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var licenseApiBaseUrl = "https://api.aikeedo.com/licenses";
  function installerView() {
    module_default.data('installer', function () {
      return {
        step: 'welcome',
        model: {
          license: null,
        ...
        view: function view(step) {
          ...
          setTimeout(function () {
            ...
            _this.required = [];
            if (_this.form) {
              _this.form.querySelectorAll('[required]').forEach(function (element) {
            ...
            if (step != 'requirements') {
              _this.checkIsSubmitable();
            }
          }, 1000);
        },
        viewRequirement: function viewRequirement() {
          var _this2 = this;
          this.isProcessing = true;
          api.post('/requirements').then(function (resp) {
            _this2.step = 'requirements';
            _this2.isProcessing = false;
            _this2.requirements = resp.data;
            _this2.view('requirements');
            _this2.isSubmitable = resp.data.is_satisfied;
          });
        },
        submitLicenseForm: function submitLicenseForm() {
          var _this3 = this;
          this.isProcessing = true;

          // Check license here
          axios$1.get("".concat(licenseApiBaseUrl, "/").concat(this.model.license)).then(function (resp) {
            _this3.isProcessing = false;
            _this3.error = null;
            _this3.view('db');
          })["catch"](function (error) {
            _this3.isProcessing = false;
            _this3.error = error.response.data.message || 'Invalid license key';
          });
        },
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 1;
                  _context.next = 4;
                  return api.post('/install', _this5.model);
                case 4:
                  _context.next = 12;
                  break;
                case 6:
                  ...
                  _this5.error = _context.t0.response.data.message || null;
                  _this5.view('failure');
                ...
                case 12:
                  ...
                  _context.prev = 14;
                  _context.next = 17;
                  return axios$1.get('https://freeipapi.com/api/json/');
                case 17:
                  resp = _context.sent;
                ...
                case 23:
                  _context.prev = 23;
                  _context.next = 26;
                  return axios$1.post("".concat(licenseApiBaseUrl, "/").concat(_this5.model.license, "/activate"), {
                    'license': _this5.model.license,
                    'domain': window.location.hostname,
                    'ip': ip,
                    'email': _this5.model.account.email,
                    'first_name': _this5.model.account.first_name,
                    'last_name': _this5.model.account.last_name,
                    'version': ''
                  });
                case 26:
                  _context.next = 30;
