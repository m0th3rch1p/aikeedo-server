...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  ins.interceptors.response.use(function (response) {
    ...
    var msg = 'Unexpected error occurred! Please try again later!';
      ...
      return {
        ...
        deleteResource: function deleteResource(resource) {
          ...
          api["delete"]("".concat(basePath, "/").concat(resource.id)).then(function () {
            ...
            window.toast.show(strings.delete_success, 'ti ti-trash');
  ...
  function presetView() {
    module_default$1.data('preset', function (preset) {
      return {
        preset: {},
        model: {},
        required: ['title'],
        ...
        watch: function watch() {
          ...
          this.required.forEach(function (field) {
            _this2.$watch("model.".concat(field), function () {
              return _this2.$refs.submit.disabled = !_this2.isSubmitable();
            });
          });
        },
        ...
        update: function update(data) {
          var _this3 = this;
          api.post("/presets/".concat(this.preset.id), data).then(function (response) {
            _this3.setPreset(response.data);
            _this3.isProcessing = false;
            window.toast.show('Template has been updated successfully!', 'ti ti-square-rounded-check-filled');
          })["catch"](function (error) {
        ...
        create: function create(data) {
          ...
          api.post('/presets', data).then(function (response) {
            _this4.setPreset(response.data);
            _this4.isProcessing = false;
            window.toast.show('Template has been created successfully!', 'ti ti-square-rounded-check-filled');
            history.pushState({}, '', "/admin/templates/".concat(_this4.preset.id));
          })["catch"](function (error) {
  ...
  function userView() {
    module_default$1.data('user', function (user) {
      return {
        user: {},
        model: {
          role: 0
        ...
        update: function update(data) {
          var _this2 = this;
          api.post("/users/".concat(this.user.id), data).then(function (response) {
            _this2.user = response.data;
            _this2.model = _objectSpread2({}, _this2.user);
            _this2.isProcessing = false;
            window.toast.show('User has been updated successfully!', 'ti ti-square-rounded-check-filled');
          })["catch"](function (error) {
        ...
        create: function create(data) {
          ...
          api.post('/users', data).then(function (response) {
            ...
            _this3.model = _objectSpread2({}, _this3.user);
            _this3.isProcessing = false;
            window.toast.show('User has been created successfully!', 'ti ti-square-rounded-check-filled');
            history.pushState({}, '', "/admin/users/".concat(_this3.user.id));
          })["catch"](function (error) {
            return _this3.isProcessing = false;
          });
        },
  ...
  function categoryView() {
    module_default$1.data('category', function (category) {
      return {
        category: {},
        model: {},
        required: ['title'],
        ...
        update: function update() {
          var _this2 = this;
          this.isProcessing = true;
          api.post("/categories/".concat(this.category.id), this.model).then(function (response) {
            _this2.category = response.data;
            _this2.model = _objectSpread2({}, _this2.category);
            _this2.isProcessing = false;
            window.toast.show('Category has been updated successfully!', 'ti ti-square-rounded-check-filled');
          });
        },
        create: function create() {
          ...
          api.post('/categories', this.model).then(function (response) {
            ...
            _this3.model = _objectSpread2({}, _this3.category);
            _this3.isProcessing = false;
            window.toast.show('Category has been created successfully!', 'ti ti-square-rounded-check-filled');
            history.pushState({}, '', "/admin/categories/".concat(_this3.category.id));
          });
        },
        isSubmitable: function isSubmitable() {
          for (var i = 0; i < this.required.length; i++) {
  ...
  function planView() {
    module_default$1.data('plan', function (plan) {
      return {
        plan: {},
        model: {},
        ...
        setModel: function setModel(model) {
          console.log(model);
          this.model = model;
          this.model.price = window.money(this.model.price).format({
            pattern: '#'
          });
        },
        watch: function watch() {
          ...
          ['token_credit', 'image_credit', 'audio_credit'].forEach(function (field) {
            _this.$watch("model.".concat(field), function (value) {
              _this.model[field] = value < 0 || value == "" ? null : value;
            });
          });
        },
        submit: function submit() {
        ...
        update: function update(data) {
          var _this2 = this;
          this.isProcessing = true;
          api.post("/plans/".concat(this.plan.id), data).then(function (response) {
            _this2.plan = response.data;
            _this2.setModel(_objectSpread2({}, _this2.plan));
            _this2.isProcessing = false;
            window.toast.show('Plan has been updated successfully!', 'ti ti-square-rounded-check-filled');
          });
        },
        create: function create(data) {
          var _this3 = this;
          api.post('/plans', data).then(function (response) {
            _this3.plan = response.data;
            _this3.setModel(_objectSpread2({}, _this3.plan));
            _this3.isProcessing = false;
            window.toast.show('Plan has been created successfully!', 'ti ti-square-rounded-check-filled');
            history.pushState({}, '', "/admin/plans/".concat(_this3.plan.id));
          });
        },
        isSubmitable: function isSubmitable() {
          for (var i = 0; i < this.required.length; i++) {
  ...
  function settingsView() {
    module_default$1.data('settings', function (path) {
      return {
        required: [],
        isProcessing: false,
        isSubmitable: false,
        ...
        init: function init() {
          var _this = this;
          this.$refs.form.addEventListener('input', function () {
        ...
        submit: function submit() {
          ...
          api.post("/options".concat(this.$refs.form.dataset.path || ''), data, {
            headers: {
              'Content-Type': 'multipart/form-data'
            }
          }).then(function (response) {
            _this2.isProcessing = false;
            window.toast.show('Changes saved successfully!', 'ti ti-square-rounded-check-filled');
          })["catch"](function (error) {
            return _this2.isProcessing = false;
          });
        },
          ...
          return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 2:
                  required = _this3.$refs.form.querySelectorAll('[required]');
                  i = 0;
                case 4:
        ...
        clearCache: function clearCache() {
          ...
          api["delete"]("/cache").then(function () {
            _this4.isProcessing = false;
            window.toast.show('Cache cleared successfully!', 'ti ti-square-rounded-check-filled');
          })["catch"](function (error) {
            return _this4.isProcessing = false;
          });
        }
